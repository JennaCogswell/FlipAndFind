...
class Game2Test {
    ...
    @get:Rule
    val activityScenarioRule = ActivityScenarioRule(GameActivity2::class.java)
    ...
    fun visibilityTest(){
        ...
        onView(withId(R.id.button14)).check(ViewAssertions.matches(isDisplayed()))
        onView(withId(R.id.button15)).check(ViewAssertions.matches(isDisplayed()))
        onView(withId(R.id.button16)).check(ViewAssertions.matches(isDisplayed()))
