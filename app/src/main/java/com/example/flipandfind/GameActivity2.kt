...
class GameActivity2 : AppCompatActivity() {
    ...
    protected val maxPairs = 8    // TODO: Change max matches in conditional based on grid size
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO: Change the number of buttons based on grid size
        buttons = listOf(
    ...
    // this method uses the prepopulated List of string names, to then fill the mutableImages list and hashmap
